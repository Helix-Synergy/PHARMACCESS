...
const Navbar = () => {
  ...
  const nav_links = [
    { name: "Home", link: "/" },
    { name: "About", link: "/about-pharmaccess" },
    { name: "Executive Panel", link: "/executive-panel-members/" },
    { name: "Tracks", link: "/pharmaccess-conference-tracks/" },
    { name: "Orators", link: "/pharmaccess-orators" },
    { name: "Schedule", link: "/pharmaccess-event-schedule" },
