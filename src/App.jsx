  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path= "/pharmaccess-orators"    element={<Orators />} />
        <Route path="/about-pharmaccess" element={<AboutOralMed />} />
        <Route path="/pharmaccess-event-schedule"element={<EventSchedule />} />
        <Route path="/venue" element={<Venue/>}/>
        <Route path="/contact" element={<ContactForm />} />
        <Route path="/pharmaccess-conference-tracks/" element={<RotatingLogos />} />
